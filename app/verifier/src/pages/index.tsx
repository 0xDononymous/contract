  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-5 pt-24 text-center">
      ...
      <p className="text-center max-w-2xl mb-4">
        Follow the steps below to prove your KYC status to the website without
        revealing your profile details.
      </p>
      ...
      <p className="leading-7 text-center max-w-2xl mt-2 mb-4">
        ...
        credential (VC) that contains their Lens KYC info. 
      </p>
      ...
      <p className="leading-7 text-center max-w-2xl mt-4 mb-2">
        ...
        . Use the app to receive a verified credential from {" "}
        <Link
          className="underline font-semibold"
          target="_blank"
      ...
      <p className="leading-7 text-center max-w-2xl mt-2 mb-4">
        Once you have the verified credential, you can use it to prove your KYC status
        to the website without revealing your Lens profile info using the Polygon ID app.
      </p>

      <p className="leading-7 text-center max-w-2xl mt-2 mb-2">
        Scan the QR code below with the Polygon ID app to prove your KYC status to the
        website.
      </p>
