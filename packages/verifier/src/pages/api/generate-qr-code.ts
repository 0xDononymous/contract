...
export default async function generateQrCode(
  ...
  const request = auth.createAuthorizationRequest(
    ...
    "Must have a valid KYC'ed Lens profile",
  ...
  request.body.scope = [
    ...scope,
    {
      ...
      query: {
        ...
        type: "lensfollowers",
        context:
          "https://raw.githubusercontent.com/teeolendo/lens-id/main/schemas/lensfollowers.jsonld",
        credentialSubject: {
          // birthday: {
          //   $lt: 20230101, // Birthday must be less than this date.
          // },
          "lensid": {
            $ne: -1, // lens followers must be a non-negative number.
          }
        },
      },
    },
